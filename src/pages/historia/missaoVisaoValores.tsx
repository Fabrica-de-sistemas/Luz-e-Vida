                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="90" height="98" viewBox="0 0 90 98" fill="none"
                        ...
                        <g clipPath="url(#clip0_129_17104)">
                            <path
                                ...
                                stroke="#FEFEFE" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M61.7319 10.4468L65.7158 3.50929" stroke="#FAB515" strokeWidth="2"
                                strokeLinecap="round" />
                            <path d="M27.5117 8.5752L22.4717 2.36244" stroke="#FAB515" strokeWidth="2"
                                strokeLinecap="round" />
                            <path d="M44.9426 6.46851L45.0405 -1.5309" stroke="#FAB515" strokeWidth="2"
                                strokeLinecap="round" />
                            <path d="M70.4607 18.4021L76.702 13.3975" stroke="#FAB515" strokeWidth="2"
                                strokeLinecap="round" />
                            <path d="M18.5066 19.6316L11.7344 15.3728" stroke="#FAB515" strokeWidth="2"
                                strokeLinecap="round" />
                            <path d="M73.5962 31.2495L81.1342 28.5702" stroke="#FAB515" strokeWidth="2"
                                strokeLinecap="round" />
                            <path d="M8.89233 29.3533L16.6454 31.3257" stroke="#FAB515" strokeWidth="2"
                                strokeLinecap="round" />
                            <path d="M71.7507 41.1794L79.4195 43.4576" stroke="#FAB515" strokeWidth="2"
                                strokeLinecap="round" />
                            <path d="M17.6638 41.9846L10.0043 44.2936" stroke="#FAB515" strokeWidth="2"
                                strokeLinecap="round" />
                        </g>
                        <defs>
                ...
                <div className="flex w-full max-w-3xl lg:max-w-4xl flex-col items-center text-center md:items-start md:text-left gap-4 mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" width="90" height="98" viewBox="0 0 90 98" fill="none"
                        ...
                        <path d=" M26.25 82.7142L32.25 77.4642C33.375 75.9642 35.25 75.2142 37.5 75.2142H52.5C56.625
                                ...
                                86.4642" stroke="#FEFEFE" strokeWidth="2.5" strokeLinecap="round"
